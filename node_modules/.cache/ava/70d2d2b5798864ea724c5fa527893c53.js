...
test('update user', async t => {
  ...
  const updated = await models.user.update(userUpdated, { where: { name: 'emailtest@gmail.com' } });
  console.log(updated);
  t.is(updated[0], 2);
});
...
//   t.is(removed, 1)
// })
//# sourceMappingURL=../../../../node_modules/.cache/ava/70d2d2b5798864ea724c5fa527893c53.js.map