...
test('update user', async t => {
  ...
  // await models.user.update(userUpdated, { where: { id: 1 } })
  // console.log(updated)

  t.is(result.dataValues.email, 'emailtest2@gmail.com');
});
//# sourceMappingURL=../../../../node_modules/.cache/ava/a0f3358145617931e04e357a2bac25ca.js.map