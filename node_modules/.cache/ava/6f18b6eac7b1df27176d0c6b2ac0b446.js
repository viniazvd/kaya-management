...
test('update user', async t => {
  ...
  const updated = await models.user.update(userUpdated, { where: { name: 'emailtest2@gmail.com' } });
  console.log(updated);
  t.is(updated[0], 2);
});
...
//   t.is(removed, 1)
// })
//# sourceMappingURL=../../../../node_modules/.cache/ava/6f18b6eac7b1df27176d0c6b2ac0b446.js.map