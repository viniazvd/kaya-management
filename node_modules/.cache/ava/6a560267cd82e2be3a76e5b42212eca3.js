...
test('update user', async t => {
  ...
  const updated = await models.user.update(userUpdated, { where: { name: 'vinitest1' } });
  console.log(updated);

  t.is(result.dataValues.email, 'emailtest@gmail.com');
});
//# sourceMappingURL=../../../../node_modules/.cache/ava/6a560267cd82e2be3a76e5b42212eca3.js.map