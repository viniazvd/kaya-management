...
test('remove user', async t => {
  const userTest = { id: 1, name: 'vinitest', email: 'emailtest@gmail.com', password: '123' };
  const newUser = await models.user.build(userTest);
  await newUser.save();

  const removed = await models.user.destroy({ where: { id: 1 } });

  console.log(removed);
  t.is(removed.affectedRows, 1);
});
//# sourceMappingURL=../../../../node_modules/.cache/ava/caf181e4f2d8a80a95412506eadd730f.js.map